...
\~/infraestructura-web/scripts/crear\_cliente.sh
...
sudo ./crear\_cliente.sh cliente1 192.168.1.135
...
\* Aplicaciones Python ejecutándose vía mod\_wsgi.
...
sudo \~/infraestructura-web/scripts/crear\_cliente.sh empresa 192.168.1.135
...
✔ Soporte Python mediante mod\_wsgi
...
Proyecto académico realizado para el módulo de \*\*Despliegue de Aplicaciones Web (DAW)\*\*.
